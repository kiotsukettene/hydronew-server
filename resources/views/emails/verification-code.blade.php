...
<body style="margin: 0; padding: 5px; font-family: 'Arial', sans-serif; background-color: #f4f4f4;">
    <div style="max-width: 500px; margin: 40px auto; background-color: #ffffff; border-radius: 12px; padding: 40px 50px; text-align: center; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
        ...
        <h2 style="color: #2E2E2E; font-size: 26px; margin-bottom: 10px;">Verify your Email</h2>
        
        <p style="color: #555; font-size: 16px; margin-bottom: 25px;">
            Hello! Thank you for signing up! Your verification code is:
        </p>
        ...
        <div style="display: flex; justify-content: center;">
            <p style="width: 90%; color: #555; font-size: 15px; line-height: 1.6; margin: 10px 0; text-align: justify;">
                Enter this code on the verification page to complete your registration. This code will expire in <strong>10 minutes</strong> for security reasons.
            </p>

        </div>
          <p style="color: #777; font-size: 14px; margin: 20px 0; text-align: justify;">
